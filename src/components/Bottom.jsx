            ...
            <div className='mt-10'>
                ...
                <div className='flex gap-5 mt-10 font-semibold text-sm'>
                    ...
                    <div className='text-justify'>
                        ...
                        <img className='h-full w-full my-2' src="https://i.ibb.co/GTkSwBc/Image05.png" alt="" srcset="" />
                        ...
                        <div className='flex gap-5 items-center'>
                            <img className='h-full w-full my-2' src="https://i.ibb.co/cQcKfvb/Image01.png" alt="" srcset="" />
